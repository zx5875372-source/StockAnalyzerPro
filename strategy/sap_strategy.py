...
class SAPScoreStrategy(BaseStrategy):
    ...
    def evaluate(self, candidate: dict, context: StrategyContext | None = None) -> StrategyResult:
        ...
        if selected:
            reasons.append("meets SAP, Piotroski, and data quality thresholds")
        else:
        ...
        return StrategyResult(
            ...
            score=self._number(candidate.get("sap_score")),
            selected=selected,
            reasons=reasons,
            warnings=warnings,
            metrics={
    ...
    def required_fields(self) -> list[str]:
        return ["symbol", "sap_score", "piotroski_score", "data_quality_score"]
